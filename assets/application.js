...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/application.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lory_js__ = __webpack_require__("../node_modules/lory.js/dist/lory.js");
...
(function () {
  document.addEventListener('DOMContentLoaded', function (e) {
    ...
    console.log(slider);
    if (slider) {
      var handleTimelineTickEvent = function handleTimelineTickEvent(e) {
        switch (e.type) {
          case 'before.lory.init':
          case 'on.lory.resize':
            Array.prototype.forEach.call(timelineControls, function (elem) {
          ...
          case 'after.lory.init':
            Array.prototype.forEach.call(timelineControls, function (elem) {
              elem.addEventListener('click', function (e) {
                e.preventDefault();
                var slideIndex = elem.dataset.slideIndex;
          ...
          case 'after.lory.slide':
            Array.prototype.forEach.call(timelineControls, function (elem) {
              ...
              timelineControls[e.detail.currentSlide - 1].classList.add('active');
            });
            break;
          default:
            return e;
      ...
      var timelineControls = Array.prototype.filter.call(document.querySelector('.timeline_controls').children, function (tControl) {
      ...
      var timelineSlider = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lory_js__["lory"])(slider, {
